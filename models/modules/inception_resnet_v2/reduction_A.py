...
class ReductionA(nn.Module):
    def __init__(self, k, l, m, n):
        super().__init__()
        # input 35x35x384, output 17x17x1024
        self.k = k
        self.l = l
        self.m = m
        self.n = n
        ...
        self.branch2 = nn.Sequential(
            ConvBlock(in_channels=384, out_channels=n, kernel_size=3, stride=2, padding=0), # output: 17x17xn
        )

        # input 35x35x384, output 17x17xm
        self.branch3 = nn.Sequential(
            ConvBlock(in_channels=384, out_channels=k, kernel_size=1, stride=1, padding=0), # output: 35x35xk
...
if __name__ == "__main__":
    reduction_a = ReductionA(k=192, l=224, m=256, n=384)
